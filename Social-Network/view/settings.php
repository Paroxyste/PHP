                ...
                <div class="form-group">
                  <label for="set_username">
                    Username
                          ...
                          <input type="text" class="form-control btn-light"
                                 id="set_username" name="set_username"
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="email" class="form-control"
                                 id="set_email" name="set_email"
                                 minlength="10" maxlength="100"
                                 value="<?php echo strip_tags($email); ?>"
                                 required />

                          <p class="text-danger mt-1">
                            <?php echo strip_tags($errEmail); ?>
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <p class="text-danger mt-1">
                            <?php echo strip_tags($errPassword); ?>
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="password" class="form-control"
                                 id="set_newpassword" name="set_newpassword"
                                 minlength="8" 
                                 placeholder="Enter new password" />

                          <p class="text-danger mt-1">
                            <?php echo strip_tags($errNewPassword); ?>
                          </p>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control"
                                 id="set_firstname" name="set_firstname"
                                 minlength="2" maxlength="20"
                                 value="<?php echo strip_tags($firstName); ?>"
                                 required />

                          <p class="text-danger mt-1">
                            <?php echo strip_tags($errFirstName); ?>
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control"
                                 id="set_lastname" name="set_lastname"
                                 minlength="2" maxlength="20"
                                 value="<?php echo strip_tags($lastName); ?>"
                                 required />

                          <p class="text-danger mt-1">
                            <?php echo strip_tags($errLastName); ?>
                          </p>
                        </div>
                      </div>
                    </div>
